...
const Contact=()=>{
     return(
         <div name="contact" className="w-full h-screen bg-gradient-to-b from-black  to-gray-800 p text-white-">
            ...
            <div className="text-white max-w-screen-lg mx-auto">
                ...
                <div className="flex justify-center items-center">
                    <form action="https://getform.io/f/jawlxndb" method="POST" className=" flex flex-col w-1/2">
                        ...
                        <input type="text" name="name" placeholder="Enter your name " className="p-2 my-4 bg-transparent border-2 rounded-md text-white focus:outline-none"></input>
